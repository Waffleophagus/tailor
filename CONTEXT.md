...
| **Perspective** | A filtered view of the graph showing only the devices and edges visible to a specific user or group. Enabled in Phase 2 with a valid API token. |
